...
<div class="flow-root mt-2 mb-36 p-4">
        <div class="flow grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="flex items-center bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 p-4">
                <a href="{{ route('beer.details', ['beer' => $beer->id]) }}" class="flex items-center block">
                    ...
                    <div class="flow-root mt-4">
                        ...
                        <div class="flow grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            @foreach($pubs as $pub)
                                <a href="{{ route('Pubs.details', ['Pub' => $pub]) }}" class="flex items-center bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 p-4 mb-4">
                                    ...
                                    <div class="flex flex-col justify-between p-4 leading-normal w-full ml-4">
                                        <div>
                                            ...
                                            <p class="mb-3 font-normal text-gray-700">Adres: {{ $pub->adress }}</p>
                                        </div>
                                    </div>
                                </a>
                            @endforeach
