...
<form class="box-border mx-auto max-w-7xl h-100 w-100 p-6 border-0" method="GET" action="{{ route('search.beer') }}">   
    ...
    <div class="relative">
        ...
        <input type="text" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-amber-600 focus:border-amber-600 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-amber-600 dark:focus:border-amber-600" placeholder="Szukaj piwa..." required>
        <button type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-amber-500 hover:bg-amber-600 focus:ring-4 focus:outline-none focus:ring-amber-600 font-medium rounded-lg text-sm px-4 py-2 dark:bg-amber-600 dark:hover:bg-amber-700 dark:focus:ring-amber-600">Szukaj</button>
    </div>
</form>
